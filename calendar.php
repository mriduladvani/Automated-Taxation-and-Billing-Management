        ...
        <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <center><h1>Last Water Bill due</h1></center>
                    ...
                    <table border="2" width="500px;" >
                      ...
                      <tr>
                        ...
                        <td id="uc"><?php echo $extractarray['Water units']?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td>Bill amount</td>
                        <td id="wba"><?php echo 4*$extractarray['Water units']?></td>
                      </tr>
                      <tr>
                        <td>Due date</td>
                        <td id="wbdd"><?php echo $extractarray['Due Date for WT']?></td>
                      </tr>
