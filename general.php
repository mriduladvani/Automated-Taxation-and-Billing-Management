        ...
        <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <center><h1>LATEST PROPERTY TAX RETURN DETAILS</h1></center>
                    <!--  THE DASHBOARD TABLE THAT CONSISTS OF ALL THE DETAILS OF THE RESPECTIVE BHAMASHAH IDENTITY USER-->
                    <center>
                    <table border="2" width="500px;" >
                      <tr>
                        <td><b>Property ID</b></td>
                        <td id="pid"><?php echo $extractarray['Property ID']?></td>
                      </tr>
                      <tr>
                        <td>Property Address:</td>
                        <td id="pad"><?php echo $extractarray['Property Address']?></td>
                      </tr>
                      <tr>
                        <td>Property Category</td>
                        <td id="pc"><?php echo $extractarray['Prop Category']?></td>
                      </tr>
                      <tr>
                        <td>Tax amount</td>
                        <td id="ta"><?php echo $extractarray['Property Tax Amount']?></td>
                      </tr>
                      <tr>
                        <td>Due date</td>
                        <td id="dd"><?php echo $extractarray['Due Date for PT']?></td>
                      </tr>
