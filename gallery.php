        ...
        <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <center><h1>Last Electric Bill due</h1></center>
                    ...
                    <table border="2" width="500px;" >
                      <tr>
                        ...
                        <td id="acn"><?php echo $extractarray['Bhamashah ID']?></td>
                      </tr>
                      <tr>
                        <td>Units consumed</td>
                        <td id="uc"><?php echo $extractarray['Electric Units']?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td>Bill amount</td>
                        <td id="wba"><?php echo 6*$extractarray['Electric Units']?></td>
                      </tr>
                      <tr>
                        <td>Due date</td>
                        <td id="wbdd"><?php echo $extractarray['Due Date for ET']?></td>
                      </tr>
