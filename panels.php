...
echo $extractarray['Bhamashah ID']; 
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <h5 class="centered"><?php echo $extractarray['Bhamashah ID']?></h5>
        ...
        <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <center><h1>LATEST INCOME TAX RETURN DETAILS</h1></center>
                    <!--  THE DASHBOARD TABLE THAT CONSISTS OF ALL THE DETAILS OF THE RESPECTIVE BHAMASHAH IDENTITY USER-->
                    <center>
                    <table border="2" width="500px;" >
                      <tr>
                        <td><b>Aadhar ID</b></td>
                        <td id="aid"><?php echo $extractarray['Aadhar ID']?></td>
                      </tr>
                      <tr>
                        <td>Income per annum:</td>
                        <td id="ipa"><?php echo $extractarray['Income/ann']?></td>
                      </tr>
                      <tr>
                        <td>% tax levied</td>
                        <td id="tl"><?php if($extractarray['Income/ann']<350000){echo 0;} else
                        {echo 6;}?></td>
                      </tr>
                      <tr>
                        <td>Tax amount</td>
                        <td id="tait"><?php echo (6/100)*($extractarray['Income/ann'])?></td>
                      </tr>
                      <tr>
                        <td>Due date</td>
                        <td id="ddit"><?php echo $extractarray['Due Date for IT']?></td>
                      </tr>
